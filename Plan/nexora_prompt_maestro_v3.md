...
## Decisión tecnológica oficial para frontend
...
La prioridad del proyecto es usar una tecnología estable, mantenible y productiva para el equipo, aprovechando el mayor dominio actual sobre Vue.
...
Por lo tanto, la elección de Vue no es solo una preferencia personal, sino una decisión estratégica del proyecto.
