...
### B4) Nueva Solicitud (Wizard) — `/app/employee/requests/new`
**Header**
- “Nueva Solicitud”
- Breadcrumb: Solicitudes / Nueva

**Wizard stepper (arriba)**
1) Tipo
2) Datos
3) Firma
4) Confirmación
...
Validación inline + mensajes claros:
- “La fecha fin no puede ser menor que la fecha inicio”
- “La hora fin debe ser mayor que la hora inicio”

#### Paso 3: Firma (siempre obligatoria)
...
#### Paso 4: Confirmación
- Resumen en card:
  - Tipo, fechas/horas, días solicitados (si aplica), observaciones
  - Líder/Gerente que aprobará (informativo)
- Checkbox: “Confirmo que la información es correcta.” (obligatorio)
- (CTA) “Enviar solicitud”

**Post envío**
- Pantalla de éxito o modal:
  - “Solicitud enviada”
  - Botón: “Ver detalle” → navega a B5
...
Mis solicitudes → Nueva solicitud → wizard (tipo/datos/firma/confirmación) → éxito → detalle
