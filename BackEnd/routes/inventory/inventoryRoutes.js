...
router.patch(
  "/purchase-documents/:id/status",
  purchaseDocumentsCtrl.changeStatus,
);
router.get("/stock-receipts", stockReceiptsCtrl.list);
router.post("/stock-receipts", stockReceiptsCtrl.create);
router.get("/stock-receipts/:id", stockReceiptsCtrl.getById);
router.post("/stock-receipts/:id/confirm", stockReceiptsCtrl.confirm);
router.get("/stock-by-product", stockCtrl.getStockByProduct);
router.get("/stock-by-warehouse", stockCtrl.getStockByWarehouse);
